  ...
  static final class AndroidChannel extends ManagedChannel {
    ...
    private class DefaultNetworkCallback extends ConnectivityManager.NetworkCallback {
      ...
      public void onLosing(Network network, int maxMsToLive) {
        ...
        Log.d(LOG_TAG, "onLosing " + network + ", " + maxMsToLive);
      }

      @Override
      public void onAvailable(Network network) {
        Log.d(LOG_TAG, "onAvailable, isConnected = " + isConnected + " network = " + network);
        if (isConnected) {
          delegate.enterIdle();
        } else {
          delegate.resetConnectBackoff();
    ...
    private class NetworkReceiver extends BroadcastReceiver {
      ...
      public void onReceive(Context context, Intent intent) {
        ...
        Log.d(LOG_TAG, "onReceive, isConnected = " + isConnected);
