...
final class DnsNameResolver extends NameResolver {
    ...
    DnsNameResolver(@Nullable String nsAuthority, String name, Helper helper,
        ...
        Log.d("MyDnsNameResolver", "create dnsResolver w name " + name + ", obj = " + this);

        logger.setLevel(Level.ALL);
        logger.addHandler(new Handler() {
            @Override
            public void publish(LogRecord record) {
                Log.d("MyDnsNameResolver", String.format(record.getMessage(), record.getParameters()));
            }
    ...
    public void shutdown() {
        Log.d("MyDnsNameResolver", "call shutdown on obj " + this);
